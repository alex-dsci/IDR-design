...
templates_path = ["."]
extlinks = {
    "issue": ("https://github.com/alex-dsci/IDR-design/issues/%s", "#"),  # noqa: E501
    "pr": ("https://github.com/alex-dsci/IDR-design/pull/%s", "PR #"),  # noqa: E501
}
...
linkcheck_ignore = [
    r"https://codecov.io/gh/alex-dsci/IDR-design/*",
]

html_theme = "sphinx_py3doc_enhanced_theme"
html_theme_path = [sphinx_py3doc_enhanced_theme.get_html_theme_path()]
html_theme_options = {
    "githuburl": "https://github.com/alex-dsci/IDR-design",
}
