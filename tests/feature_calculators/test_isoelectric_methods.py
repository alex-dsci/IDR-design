...
class Test:
    ...
    def test_my_halley(self):
        ...
        for seq in self.seqs:
            ...
            assert abs(new_val - old_val) < TEST_TOLERANCE
        print()
        print(f"Time halleys (mine): {halley_clock / len(self.seqs)}")
        print(f"Time bisect (old code): {old_method_clock / len(self.seqs)}")
    ...
    def _test_generic_scipy(self, method_name: str):
        ...
        for seq in self.seqs:
            ...
            assert abs(new_val - old_val) < TEST_TOLERANCE
        print()
        print(f"Time {method_name} (scipy): {new_method_clock / len(self.seqs)}")
